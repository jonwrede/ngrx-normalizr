 ...
 */
export const initialState: NormalizedEntityState = {
  result: [],
  entities: {}
};
...
export function createSchemaSelectors<T>(
  ...
  return {
     ...
     */
    getEntities: createEntitiesSelector<T>(schema, getNormalizedEntities),
 ...
 */
export function createEntitiesSelector<T>(
  schema: schema.Entity,
  normalizedEntities: MemoizedSelector<any, EntityMap>
): MemoizedSelector<{}, T[]> {
 ...
 * @param schema The schema to bind this selector to
 */
export function createEntityProjector<T>(schema: schema.Entity) {
 ...
 * @param schema The schema to bind this selector to
 */
export function createEntitiesProjector<T>(schema: schema.Entity) {
 ...
 * @param schema The schema to bind this selector to
 */
export function createSingleDenormalizer(schema: schema.Entity) {
 ...
 * @param schema The schema to bind this selector to
 */
export function createMultipleDenormalizer(schema: schema.Entity) {
  const key = schema.key;
 ...
 */
export function getParentReferences(
  entities: any,
